...
"""Set S3 access key secrets in Secrets Manager."""
...
if len(sys.argv) != 2:
    raise SystemExit("usage: put_s3_secrets.py <tofu-env-dir>")
env_dir = sys.argv[1]
...
values = {
    ...
    "S3_SECRET_ACCESS_KEY": getpass.getpass("S3_SECRET_ACCESS_KEY: "),
}
